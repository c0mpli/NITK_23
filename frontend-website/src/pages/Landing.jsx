     ...
     <div className='aboutUsSlider'>
      ...
      <div className="landing-footer" ref={contactusRef}>
        <div className="footer-content">
          <h1>Contact Us</h1>
          <p>
            Heath Matthews Physio brings you better health and fitness through
            technology and expertise. Everyone from Olympians to weekend
            warriors can benefit from Heath Matthews Physio to heal faster,
          ...
          <div className="footer-icons">
            ...
            />
            <p>support@heathmatthewsphysio.com</p>
          </div>
