  ...
  return (
    <div className="AppGlass2">
      ...
      <div className="ContentWrapper">
        <h1 style={{ padding: "2rem" }}>Pending requests</h1>
        <div className="AppGlass3">
          {isCourse ? (
            <SpecificCourse courseKey={courseKey} courses={programs} />
          ) : (
            <div>
              {programs &&
                    ...
                    <div id={key}>
                      ...
                      >
                        ...
                        <div className="ProgramDurationWrapper">
                          ...
                          <h3 style={{ color: "#FFB800", fontSize: "3rem" }}>
                            {program.duration}
                          </h3>
